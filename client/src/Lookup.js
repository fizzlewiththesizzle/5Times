...
const Lookup = () => {
    ...
    return (
        ...
        <PageTransition>
            <div className='bg-gray-200 dark:bg-gray-800 dark:text-white rounded-2xl overflow-hidden text-left xs:text-center md:text-left xl:text-left 2xl:text-left mt-4 shadow-lg px-8 pt-4 pb-4 space-y-2'>
                ...
                <form onSubmit={handleSubmit}>
                    <div className="flex space-x-4 justify-center"> {/* Flex container for side-by-side layout */}
                        ...
                        <select className="dark:text-white xs:text-xl bg-white dark:bg-gray-700 font-semibold rounded-lg shadow-lg block p-2.5 w-full appearance-none" value={selectedMonth} onChange={handleMonthChange}>
                            {[...Array(12).keys()].map(i => (
                        ...
                        <select className="dark:text-white text-xl bg-white dark:bg-gray-700 font-semibold rounded-lg shadow-lg block p-2.5 w-full appearance-none" value={selectedDay} onChange={handleDayChange} disabled={!selectedMonth}>
                    ...
                    <button className='bg-emerald-500 hover:bg-emerald-600 text-white font-bold text-xl py-2 px-4 rounded-lg shadow-lg mt-4' type="submit">Submit</button>
                </form>
            </div>
            </PageTransition>
