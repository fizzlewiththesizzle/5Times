...
function TV() {
    ...
    return (
        <React.Fragment>
            <div className='grid grid-cols-3 gap-4 mt-6 ml-4 mr-4'>
                <div className='col-span-2'>
                    <EmblaCarousel slides={SLIDES} options={OPTIONS} />
                </div>
                
                <div>
                    <table className="rounded-2xl overflow-hidden shadow-lg w-full border-collapse">
                        <thead className="bg-gray-200 dark:bg-gray-800 dark:text-white">
                            <tr>
                            <th className="py-2 px-4 xl:text-3xl 2xl:text-4xl flex">Prayer</th>
                            <th className="py-2 px-4 xl:text-3xl 2xl:text-4xl text-center">Adhan</th>
                            <th className="py-2 px-4 xl:text-3xl 2xl:text-4xl text-right">Iqama</th>
                            </tr>
                        </thead>
                        <tbody>
                            {prayerData.map(prayer => (
                                <React.Fragment key={prayer.id}>
                                    <tr className="bg-white dark:bg-gray-700 dark:text-white">
                                        <td className="py-2 px-4 xl:text-2xl 2xl:text-3xl">
                                        ...
                                        <td className={`py-2 px-4 xl:text-2xl 2xl:text-3xl text-center ${nextPrayer.next === "Fajr Adhan" ? 'text-emerald-500 font-bold' : ''}`}>{prayer.fajr_adhan} AM</td>
                                        <td className={`py-2 px-4 xl:text-2xl 2xl:text-3xl text-right ${nextPrayer.next === "Fajr Iqama" ? 'text-emerald-500 font-bold' : ''}`}>{prayer.fajr_iqama} AM</td>
                                    </tr>
                                    <tr className="bg-gray-100 dark:bg-gray-800 dark:text-white">
                                        ...
                                        <td className={`py-2 px-4 xl:text-2xl 2xl:text-3xl text-center ${nextPrayer.next === "Sunrise" ? 'text-emerald-500 font-bold' : ''}`}>{prayer.sunrise} AM</td>
                                        <td className="py-2 px-4 xl:text-2xl 2xl:text-3xl text-center xl:text-right 2xl:text-right">---</td>
                                    </tr>
                                    <tr className="bg-white dark:bg-gray-700 dark:text-white">
                                        <td className="py-2 px-4 xl:text-2xl 2xl:text-3xl">
                                            <div className="flex items-center">
                                        ...
                                        <td className={`py-2 px-4 xl:text-2xl 2xl:text-3xl text-center ${nextPrayer.next === "Dhuhr Adhan" ? 'text-emerald-500 font-bold' : ''}`}>{prayer.dhuhr_adhan} PM</td>
                                        <td className={`py-2 px-4 xl:text-2xl 2xl:text-3xl text-right ${nextPrayer.next === "Dhuhr Iqama" ? 'text-emerald-500 font-bold' : ''}`}>{prayer.dhuhr_iqama} PM</td>
                                    </tr>
                                    <tr className="bg-gray-100 dark:bg-gray-800 dark:text-white">
                                        <td className="py-2 px-4 xl:text-2xl 2xl:text-3xl">
                                            <div className="flex items-center">
                                        ...
                                        <td className={`py-2 px-4 xl:text-2xl 2xl:text-3xl text-center ${nextPrayer.next === "Asr Adhan" ? 'text-emerald-500 font-bold' : ''}`}>{prayer.asr_adhan} PM</td>
                                        <td className={`py-2 px-4 xl:text-2xl 2xl:text-3xl text-right ${nextPrayer.next === "Asr Iqama" ? 'text-emerald-500 font-bold' : ''}`}>{prayer.asr_iqama} PM</td>
                                    </tr>
                                    <tr className="bg-white dark:bg-gray-700 dark:text-white">
                                        <td className="py-2 px-4 xl:text-2xl 2xl:text-3xl">
                                            <div className="flex items-center">
                                        ...
                                        <td className={`py-2 px-4 xl:text-2xl 2xl:text-3xl text-center ${nextPrayer.next === "Maghrib Adhan" ? 'text-emerald-500 font-bold' : ''}`}>{prayer.maghrib_adhan} PM</td>
                                        <td className={`py-2 px-4 xl:text-2xl 2xl:text-3xl text-right ${nextPrayer.next === "Maghrib Iqama" ? 'text-emerald-500 font-bold' : ''}`}>{prayer.maghrib_iqama} PM</td>
                                    </tr>
                                    <tr className="bg-gray-100 dark:bg-gray-800 dark:text-white">
                                        <td className="py-2 px-4 xl:text-2xl 2xl:text-3xl">
                                            <div className="flex items-center">
                                        ...
                                        <td className={`py-2 px-4 xl:text-2xl 2xl:text-3xl text-center ${nextPrayer.next === "Isha Adhan" ? 'text-emerald-500 font-bold' : ''}`}>{prayer.isha_adhan} PM</td>
                                        <td className={`py-2 px-4 xl:text-2xl 2xl:text-3xl text-right ${nextPrayer.next === "Isha Iqama" ? 'text-emerald-500 font-bold' : ''}`}>{prayer.isha_iqama} PM</td>
                                    </tr>
                                </React.Fragment>
                            ))}
                        </tbody>
                    </table>
                    <div className="bg-gray-200 dark:bg-gray-800 rounded-2xl overflow-hidden text-center text-emerald-500 font-semibold shadow-lg xl:text-4xl 2xl:text-5xl px-4 mt-4 space-y-8">
                        <h1 className="pt-4">
                            {prayerData.length > 0
                ...
                <div className='dark:text-white text-center text-7xl font-mono font-bold flex justify-center items-center'>
                    <Clock></Clock>
                </div>
            </div>
        </React.Fragment>
