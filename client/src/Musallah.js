            ...
            <div className="grid grid-cols-2 gap-4 4xl:gap-8 mt-6 4xl:mt-12 ml-4 4xl:ml-8 mr-4 4xl:mr-8">
                ...
                <div className="space-y-4 4xl:space-y-8">
                    ...
                    <div className="rounded-2xl 4xl:rounded-3xl overflow-hidden shadow-lg bg-gray-200 dark:bg-gray-800 text-center flex flex-col justify-center items-center">
                        <h1 className="text-6xl 4xl:text-9xl dark:text-white font-bold pt-10">Next Up:</h1>
                        <h1 className="text-6xl 4xl:text-10xl font-semibold text-emerald-500 my-auto pb-10">{nextPrayer}</h1>
                    </div>
                ...
                <table className="rounded-2xl 4xl:rounded-3xl overflow-hidden shadow-lg w-full border-collapse">
                        ...
                        <tbody>
                            <tr className="bg-white dark:bg-gray-700 dark:text-white">
                                ...
                                <td className={`py-2 px-4 4xl:py-8 4xl:px-8 xl:text-2xl 2xl:text-3xl 4xl:text-8xl text-center ${nextPrayer === "Fajr Adhan" ? 'text-emerald-500 font-bold' : ''} whitespace-nowrap`}>{fajrAdhan} AM</td>
                                <td className={`py-2 px-4 4xl:py-8 4xl:px-8 xl:text-2xl 2xl:text-3xl 4xl:text-8xl text-right ${nextPrayer === "Fajr Iqama" ? 'text-emerald-500 font-bold' : ''} whitespace-nowrap`}>{fajrIqama} AM</td>
                            </tr>
                            <tr className="bg-gray-100 dark:bg-gray-800 dark:text-white">
                                ...
                                <td className={`py-2 px-4 4xl:py-8 4xl:px-8 xl:text-2xl 2xl:text-3xl 4xl:text-8xl text-center ${nextPrayer === "Sunrise" ? 'text-emerald-500 font-bold' : ''} whitespace-nowrap`}>{sunrise} AM</td>
                            ...
                            <tr className="bg-white dark:bg-gray-700 dark:text-white">
                                ...
                                <td className={`py-2 px-4 4xl:py-8 4xl:px-8 xl:text-2xl 2xl:text-3xl 4xl:text-8xl text-center ${nextPrayer === "Dhuhr Adhan" ? 'text-emerald-500 font-bold' : ''} whitespace-nowrap`}>{dhuhrAdhan} PM</td>
                                <td className={`py-2 px-4 4xl:py-8 4xl:px-8 xl:text-2xl 2xl:text-3xl 4xl:text-8xl text-right ${nextPrayer === "Dhuhr Iqama" ? 'text-emerald-500 font-bold' : ''} whitespace-nowrap`}>{dhuhrIqama} PM</td>
                            </tr>
                            <tr className="bg-gray-100 dark:bg-gray-800 dark:text-white">
                                <td className="py-2 px-4 4xl:py-8 4xl:px-8 xl:text-2xl 2xl:text-3xl 4xl:text-8xl">
                                    <div className="flex items-center">
                                ...
                                <td className={`py-2 px-4 4xl:py-8 4xl:px-8 xl:text-2xl 2xl:text-3xl 4xl:text-8xl text-center ${nextPrayer === "Asr Adhan" ? 'text-emerald-500 font-bold' : ''} whitespace-nowrap`}>{asrAdhan} PM</td>
                                <td className={`py-2 px-4 4xl:py-8 4xl:px-8 xl:text-2xl 2xl:text-3xl 4xl:text-8xl text-right ${nextPrayer === "Asr Iqama" ? 'text-emerald-500 font-bold' : ''} whitespace-nowrap`}>{asrIqama} PM</td>
                            </tr>
                            <tr className="bg-white dark:bg-gray-700 dark:text-white">
                                <td className="py-2 px-4 4xl:py-8 4xl:px-8 xl:text-2xl 2xl:text-3xl 4xl:text-8xl">
                                    <div className="flex items-center">
                                ...
                                <td className={`py-2 px-4 4xl:py-8 4xl:px-8 xl:text-2xl 2xl:text-3xl 4xl:text-8xl text-center ${nextPrayer === "Maghrib Adhan" ? 'text-emerald-500 font-bold' : ''} whitespace-nowrap`}>{maghribAdhan} PM</td>
                                <td className={`py-2 px-4 4xl:py-8 4xl:px-8 xl:text-2xl 2xl:text-3xl 4xl:text-8xl text-right ${nextPrayer === "Maghrib Iqama" ? 'text-emerald-500 font-bold' : ''} whitespace-nowrap`}>{maghribIqama} PM</td>
                            </tr>
                            <tr className="bg-gray-100 dark:bg-gray-800 dark:text-white">
                                <td className="py-2 px-4 4xl:py-8 4xl:px-8 xl:text-2xl 2xl:text-3xl 4xl:text-8xl">
                                    <div className="flex items-center">
                                ...
                                <td className={`py-2 px-4 4xl:py-8 4xl:px-8 xl:text-2xl 2xl:text-3xl 4xl:text-8xl text-center ${nextPrayer === "Isha Adhan" ? 'text-emerald-500 font-bold' : ''} whitespace-nowrap`}>{ishaAdhan} PM</td>
                                <td className={`py-2 px-4 4xl:py-8 4xl:px-8 xl:text-2xl 2xl:text-3xl 4xl:text-8xl text-right ${nextPrayer === "Isha Iqama" ? 'text-emerald-500 font-bold' : ''} whitespace-nowrap`}>{ishaIqama} PM</td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <div className="text-center dark:text-white">
                        ...
                        <div className="clock-font font-bold xl:text-5xl 2xl:text-6xl 4xl:text-10xl text-emerald-500">
                            <Countdown></Countdown>
                        </div>
                    </div>
