            ...
            <div className='grid grid-cols-3 gap-4 4xl:gap-8 mt-6 4xl:mt-12 ml-4 4xl:ml-8 mr-4 4xl:mr-8'>
                <div className='col-span-2'>
                    ...
                    <div class="iframe-container rounded-2xl 4xl:rounded-3xl shadow-lg">
                        <iframe title="Slides" src="https://docs.google.com/presentation/d/11jzRfVxNK0DLT5XIE3JelPraUhj3kTKplUm5FReRoFA/embed?start=true&loop=true&delayms=8000&rm=minimal" frameborder="0" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true"></iframe>
                    </div>
                </div>
